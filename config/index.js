export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx4adf38247b1bbbb0",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "a1e860d2e06c1d43f5b180f96a832da5",
  ...
  USERS: [
    {
      ...
      id: "oWlEv5jYtrMHzrasBvG8hfdQFQEo",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "fdMVqnYmQIge83BzfZAvPg7bvDb9PrLoDW_2dqyX3v8",
      // 所在省份
      province: "湖南",
      // 所在城市
      city: "长沙",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oWlEv5p3E7KpcwQ8H4xOg8SsxuWU",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
